...
public:
	...
	///\brief Getter: Gets the Bitmap resource this sprite is using
	///\return The Bitmap resource being used by this sprite
	Bitmap bitmap();

	///\brief Setter: Sets the Bitmap resource to be used by this sprite
	///\param bmp The bitmap to be used by the sprite
...
private:
	...
	Bitmap bitmap_;	///< The bitmap resource for this sprite
