...
#define FARMABLE_OFFSET	5
	...
	bool isWalkable() { return ((flags & (1 << WALKABLE_OFFSET))==1); }
	bool isFarmable() { return ((flags & (1 << FARMABLE_OFFSET))==1); }
	bool isPlanted()  { return ((flags & (1 << PLANTED_OFFSET))==1); }
	bool isTilled()   { return ((flags & (1 << TILLED_OFFSET))==1); }
