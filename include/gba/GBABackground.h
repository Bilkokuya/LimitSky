...
#ifndef GBA_BACKGROUND
#define GBA_BACKGROUND
...
/// with simple functions Afor easy access to contained information
class GBABackground
{
public:
	...
	GBABackground(int bgNumber, int xOff=0, int yOff=0)
	{
	...
	GBABackground(int bgNumber, int xOff, int yOff, int charblock, int screenblock)
	{
